...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Jeary', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '静逅佳音', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://web.asusai.cn', // 网站地址
